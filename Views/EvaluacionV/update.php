...
<div class="container">
  ...
  <h2 class="mt-3 ">Actualizacion de Lectura</h2>
	...
	<form method="post" action="?controller=evaluacionV&action=update" name="formulario">
      ...
      <div class=" mt-3">
        <label for="numeroSerieMedidor" class="col-auto col-form-label">Número Serie del Medidor s:</label>
        <div class="col-auto">
      ...
      <div class="mt-3">
        <label for="estadoMedidor" class="col-auto col-form-label">Estado Medidor s:</label>
        <div class="col-auto">
      ...
      <div class="mt-3">
        ...
        <button type="button" class="btn btn-secondary " onclick="location.href='?controller=evaluacionV&action=show'">Cancelar</button>
      </div>
	</form>
</div>
