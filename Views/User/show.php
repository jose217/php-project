...
<div class="container">
    <h1 class="mt-3">Lista de Usuarios Registrados</h1>
    <button type="button" class="btn btn-primary" 
        onclick="location.href='?controller=usuario&action=register'">
        <span class="p-1">
    ...
    <button type="button" class="btn btn-success" 
        onclick="location.href='?controller=usuario&action=showUsuarios'"><span class="p-1"><i
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Buscar Usuario Registrado.</h5>
                </div>
                    ...
                    <ul class="list-group">
                        <li class="list-group-item" style="border:none;">
                            <form class="form-inline" action="?controller=usuario&action=buscar" method="post"
                                name="ola" id="oplm">
                                <div class="">
                                    <label for="nombres" class="col-auto col-form-label">Nombres:</label>
                                    <div class="col-auto">
    ...
    <div style="margin-top:1%;" class="container">
        <div class="table-responsive">
            ...
            <table id="Table" class="table research" style="width:100%;">
                ...
                <tbody>
                    <?php
                    foreach ($paginationUtils->getListaElementos() as $lusuario) { ?>
                        <tr class="accordion">
                            <td>
                                <?php echo $lusuario->getNombres(); ?>
                            </td>
                            <td>
                                <?php echo $lusuario->getApellidos(); ?>
                            </td>
                            <td>
                                <?php echo $lusuario->getEmail(); ?>
                            </td>
                            <td>
                                <?php echo $lusuario->getAlias(); ?>
                            </td>

                            <td id="hide" class="notog"><button type="button" class="btn btn-danger"
                                    onclick="location.href='?controller=usuario&action=delete&id=<?php echo $lusuario->getId(); ?>'"><span
                            ...
                            <td id="hide" class="notog"><button type="button" class="btn btn-primary"
                                    onclick="location.href='?controller=usuario&action=showupdate&id=<?php echo $lusuario->getId(); ?>'"><i
    ...
    <nav aria-label="Page navigation " id="lol1">
        <ul class="pagination justify-content-center" id="lol1">
            <?php if ($paginationUtils->getActivoAnterior()) { ?>
                <li class="page-item">
                    <a class="page-link" href=?controller=usuario&action=showUsuarios&boton=<?php echo $paginationUtils->getAnterior(); ?>">Previous</a>
                </li>
            <?php } else { ?>
                <li class="page-item disabled"><a class="page-link" href="#" tabindex="-1">&laquo;</a></li>
            <?php } ?>
            <?php if ($paginationUtils->getVisiblePrimero()) { ?>
                <li class="page-item"><a class="page-link" href=?controller=usuario&action=showUsuarios&boton=<?php echo $paginationUtils->getPrimero(); ?>"><?php echo $paginationUtils->getPrimero(); ?></a>
                </li>
            ...
            for ($i = $paginationUtils->getInicioPaginacion(); $i <= $paginationUtils->getNumeroCiclos(); $i++) { ?>
                ...
                <?php } else { ?>
                    <li class="page-item"><a class="page-link" href=?controller=usuario&action=showUsuarios&boton=<?php echo $i ?>"><?php echo $i; ?></a></li>
                <?php } ?>
            <?php }
            if ($paginationUtils->getVisibleUltimo()) { ?>
                <li class="page-item disabled"><a class="page-link" href="#">...</a></li>
                <li class="page-item"><a class="page-link" href=?controller=usuario&action=showUsuarios&boton=<?php echo $paginationUtils->getUltimo(); ?>"><?php echo $paginationUtils->getUltimo(); ?></a>
                </li>
            <?php } ?>
            <?php if ($paginationUtils->getActivoSiguiente()) { ?>
                <li class="page-item"><a class="page-link" href=?controller=usuario&action=showUsuarios&boton=<?php echo $paginationUtils->getSiguiente(); ?>">next</a>
                </li>
            <?php } else { ?>
