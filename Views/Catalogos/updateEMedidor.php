...
<div class="container">
  <div>
    <h2 class="mt-3 ">Actualización de Estado de Medidor</h2>
  </div>
  <form action="?controller=catalogos&action=updateEMedidor" method="post" name="formulario">
    <input type="hidden" id="id" name="id" value="<?php echo $catalogos->getId(); ?>">
    <div class=" mt-3">
      <label for="nombre" class="col-auto col-form-label">Estado de Medidor:</label>
      <div class="col-auto">
