...
{
    function detalleHistoria($numero_hc, $cedula, $nom_ap)
    {
        ...
        $this->Cell(67,10,  utf8_decode('Nombres : '.$nom_ap),1, 0 , 'L' );

    }

    function detallePersonales($genero, $edad_menarquia,$edad_menopausia, $vida_sexual,$ciclos,$edad_gestacion,$numero_partos,$numero_abortos,$numero_cesareas,$fecha_ultima_menstruacion,$fecha_ultimo_parto,$hijos_vivos,$mp_familiar,$des_ap)
    {
        //DATOS AP
        $this->SetFont('Arial','B',9);
        $this->SetXY(10, 40);
    ...
    function detalleFamiliares($cardiopatia, $diabetes,$cancer,$enfcardiovasculares,$hipertension,$enfmentales,$tuberculosis,$enfinfecciosas, $malformacion, $otra,$des_af)
    {
        //DATOS AF
        //DATOS AF
        $this->SetFont('Arial','B',9);
